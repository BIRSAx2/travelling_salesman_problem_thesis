...
\begin{itemize}
  \item MAX-MIN Ant System (\lgs{MMAS}): Introdotto da Stützle e Hoos, \gls{MMAS} limita i valori dei feromoni entro un intervallo predefinito per prevenire la stagnazione prematura. \cite{Stuetzle1997}
