...
\benchmarktic
\PassOptionsToPackage{table,svgnames, rgb}{xcolor}
\PassOptionsToPackage{pdftex,pdfa,bookmarksnumbered=true, breaklinks=true, colorlinks=true, pdfdisplaydoctitle=true, unicode=true}{hyperref}
